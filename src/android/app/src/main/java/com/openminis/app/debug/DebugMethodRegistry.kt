    ...
    private val BASE_METHODS: List<MethodSpec> = listOf(
        ...
        MethodSpec(
            ...
            params = listOf(
                ...
                ParamSpec("proxyUrl", "string", required = false, description = "Per-instance HTTP proxy override (http://host:port). Empty = app-level proxy."),
        ...
        MethodSpec(
            ...
            params = listOf(
                ...
                ParamSpec("proxyUrl", "string", required = false, description = "Per-instance HTTP proxy override (http://host:port). null/\"\" reverts to app-level proxy."),
