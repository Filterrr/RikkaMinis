...
fun SettingsScreen(
    ...
    // [OPT-doh/OPT-proxy] Network settings entry (DoH / app proxy / pool).
    // Default no-op for back-compat, mirroring the other optional entries.
    onNetworkClick: () -> Unit = {},
) {
    ...
    Scaffold(
        ...
        Column(
            ...
            SettingsSection(
                ...
                // [OPT-doh/OPT-proxy] Network — DoH, app-level proxy,
