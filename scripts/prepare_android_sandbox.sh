...
#   1. Download Ubuntu Base aarch64 rootfs (glibc, apt/dpkg)
...
UBUNTU_URL="https://cdimage.ubuntu.com/ubuntu-base/releases/${UBUNTU_SERIES}/release/ubuntu-base-${UBUNTU_POINT}-base-arm64.tar.gz"
